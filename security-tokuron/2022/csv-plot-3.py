...
input_csv3 = pd.read_csv(args[3])
first_column_data3 = input_csv3[input_csv3.keys()[3]]
second_column_data3 = input_csv3[input_csv3.keys()[2]]

ax3 = fig.add_subplot(1, 3, 3)
ax3.set_title("agglomerative clustering")
ax3.scatter(first_column_data3, second_column_data3)

...
def plot_coordinates_with_dbscan(csv_file_path, db_path, output_csv_path, output_plot_path):
    ...
    plt.title('DBSCAN Clustering of IP Address Geolocation (Latitude vs Longitude)')
...
output_plot_path = 'coordinates_dbscan_plot.png'  # 2次元座標プロットを保存する画像ファイル

plot_coordinates_with_dbscan(csv_file_path, db_path, output_csv_path, output_plot_path)
